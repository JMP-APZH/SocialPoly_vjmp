...
from user.views import ListAllUsersView, SpecificUserView, RetrieveUpdateProfileView, UpdateUserLinkedinView

urlpatterns = [
    path('list/', ListAllUsersView.as_view()),
    path('me/', RetrieveUpdateProfileView.as_view()),
    path('me/linkedin/', UpdateUserLinkedinView.as_view()),
